...
cuda_configure = repository_rule(
    ...
    attrs = {
        ...
        "local_config_cuda_build_file": attr.label(default = Label("//gpu/cuda:local_config_cuda.BUILD")),
        "build_defs_tpl": attr.label(default = Label("//gpu/cuda:build_defs.bzl.tpl")),
